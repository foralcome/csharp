...
int [,] FillArray2dRundom(int countRows=3, int countColumns=3, int minRandomValue=1, int maxRandomValue=100)
{
...
{
    int [,]array2d = FillArray2dRundom(countRows, countColumns, 10, 99);
